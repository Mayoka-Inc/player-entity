...
## Module Focus: Player Entity

The **Player Entity** controls the ship's visual representation, movement constraints, and state-based animations.

**Superpowers:**
- Fluid movement interpolation for smooth navigation.
- State-driven visual effects (e.g., speed blur, collision flashes).
- Precise hitbox management and movement boundary enforcement.
